...
export function CameraControls({ onControl, disabled = false }) {
  ...
  const handleZoomChange = (value) => {
    setZoomLevel(value)
    onControl("zoom", value)
  }

  const handleTiltChange = (value) => {
    setTiltLevel(value)
    onControl("tilt", value)
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-700 rounded-xl p-4 border border-gray-600">
        ...
        <div className="flex items-center gap-4">
          <ControlButton action="tilt/down" size="small">
          ...
          <ControlButton action="tilt/up" size="small">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z"
      ...
      <div className="bg-gray-700 rounded-xl p-4 border border-gray-600">
        ...
        <div className="flex items-center gap-4">
          <ControlButton action="zoom/out" size="small">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
          ...
          <ControlButton action="zoom/in" size="small">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
      ...
      <div className="bg-gray-700 rounded-xl p-4 border border-gray-600">
        ...
        <div className="flex items-center gap-4">
          <ControlButton action="pan/left" size="small">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z"
          ...
          <ControlButton action="pan/right" size="small">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
